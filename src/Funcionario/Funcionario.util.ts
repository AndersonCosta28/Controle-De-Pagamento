...
import { QntdDiasNoMes, TemplateSwaggerUtils } from "../utils"
...
export const path_util_CalcularSalarioProporcionalDTO = template_calcularSalarioProporcional.pathComParametroByID('post');
export const component_util_CalcularSalarioProporcionalDTO = template_calcularSalarioProporcional.component();
export const path_util_CalcularSalarioLiquidoDTO = template_calcularSalarioLiquido.pathComParametroByID('post');
export const component_util_CalcularSalarioLiquidoDTO = template_calcularSalarioLiquido.component();